...
![Visualization of 3D data collected through high resolution scanning of a land engraved area. Striations on the surface of the object can be seen by viewing this data from "above", as presented here. *HH: include a sketch of a bullet with a marker of which area is included. Why did you decide on going to a grey scale for the figure?*](./images/3d_plot_top.png){width=600px}  
