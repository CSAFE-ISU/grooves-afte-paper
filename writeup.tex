...
\autoref{fig:LEA}. Parts of the breakoff \ug{(define?)} are captured as
...
\ug{Not sure the following sentence/paragraph expresses clearly what I think you want to say.}
\kr{Updated paragraph below would replace this:} While robust LOESS
methods are more flexible than robust linear models, a model that is
accurately fit to the LEA structure \ug{still} results in the same
