...
of LEAs from two bullet test sets. This separation method outperforms
current methods at separating LEA and GEA data.
\end{abstract}
...
{\color{teal}{Separate out Table 1 to be for Hamby/Houston data separately. Also, update conclusions section to be correct with updated data.}}
